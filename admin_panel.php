...
<head>
   ...
   <title>AdminPanel | Buchpedia Admin</title>
   ...
   <section class="dashboard">
      ...
      <div class="box-container">
         <div class="box">
            <?php
            $total_pendings = 0;
            $select_pending = mysqli_query($conn, "SELECT total_price FROM `orders` WHERE payment_status = 'Tertunda'") or die('query failed');
         ...
         <div class="box">
            <?php
            $total_completed = 0;
            $select_completed = mysqli_query($conn, "SELECT total_price FROM `orders` WHERE payment_status = 'Selesai'") or die('query failed');

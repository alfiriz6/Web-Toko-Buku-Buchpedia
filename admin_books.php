...
<head>
   ...
   <title>Buku | Buchpedia Admin</title>
...
<body>
   ...
   <section class="add-books">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <input type="text" name="name" class="box" placeholder="Masukkan judul buku" required>
         <input type="number" min="0" name="price" class="box" placeholder="Masukkan harga buku" required>
         <input type="file" name="image" accept="image/jpg, image/jpeg, image/png" class="box" required>
         <input type="submit" value="Tambahkan Buku" name="add_book" class="btn">
      </form>
   </section>
      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <a href="admin_books.php?delete=<?php echo $fetch_books['id']; ?>" class="delete-btn" onclick="return confirm('Hapus buku terpilih?');">delete</a>
               </div>
         <?php
            }
         } else {
